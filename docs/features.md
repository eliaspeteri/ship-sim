...
- [ ] Navigation Systems
  ...
  - [ ] Electronic Navigation
    - [x] ECDIS (Electronic Chart Display) (see docs/features/ecdis.md for detailed feature tracking)
    - [ ] Conning Display (see docs/features/conning.md for detailed feature tracking)
