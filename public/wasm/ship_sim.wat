(module
 ...
 (type $6 (func (param i32 f64) (result i32)))
 ...
 (export "updateVesselState" (func $export:assembly/index/updateVesselState))
 (start $~start)
 ...
 (func $assembly/index/updateVesselState (param $0 i32) (param $1 f64) (result i32)
  (local $2 f64)
  (local $3 f64)
  (local $4 f64)
  (local $5 f64)
 ...
 (func $export:assembly/index/updateVesselState (param $0 i32) (param $1 f64) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
